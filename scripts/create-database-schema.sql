...
CREATE TABLE IF NOT EXISTS deals (
  ...
  name VARCHAR(150) NOT NULL,
  description TEXT,
  deal_type VARCHAR(50) DEFAULT 'discount', -- discount, combo, bogo, bundle
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  status VARCHAR(50) DEFAULT 'pending', -- pending, preparing, out_for_delivery, completed, cancelled
