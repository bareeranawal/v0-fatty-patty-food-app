...
export async function POST(request: Request) {
  try {
    ...
    const { customerName, email, orderId, items, total, orderType, estimatedTime, area, branch } = body
...
Thank you for your order at Fatty Patty!
...
Thank you for choosing Fatty Patty!
Original Taste Since 2020.

---
This is an automated confirmation. For questions, call us at 0334 2024 000 or email fattypatty@gmail.com.
    `.trim()

    // In production, integrate with a real email service (Resend, SendGrid, etc.)
    // For now we log the email and return success
    console.log('[v0] Order confirmation email:', { to: email, subject: `Order Confirmed - ${orderId}`, body: emailBody })
