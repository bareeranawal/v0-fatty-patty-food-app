        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="space-y-5">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="flex items-start gap-3 rounded-xl border border-border bg-card p-4 shadow-sm transition-all duration-300 hover:shadow-md">
                <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-[#C1121F]/10">
                  <MapPin className="h-5 w-5 text-[#C1121F]" />
                </div>
                <div>
              ...
              <div className="sm:col-span-2 flex items-start gap-3 rounded-xl border border-border bg-card p-4 shadow-sm transition-all duration-300 hover:shadow-md">
                <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-[#C1121F]/10">
                  <Clock className="h-5 w-5 text-[#C1121F]" />
                </div>
                <div>
          ...
          <div className="rounded-2xl border border-border bg-card p-8 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#C1121F] px-6 py-3.5 text-sm font-semibold text-white transition-all hover:bg-[#C1121F]/90 active:scale-[0.98] disabled:opacity-50"
              >
