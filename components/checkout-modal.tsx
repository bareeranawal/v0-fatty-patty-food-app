      ...
      <div className="fixed inset-0 z-[60] flex items-center justify-center bg-brand-dark/50 backdrop-blur-sm p-4">
        <div className="w-full max-w-md rounded-2xl bg-card p-8 text-center shadow-2xl">
          ...
          <p className="mb-6 text-sm font-medium text-foreground">
            Order ID: <span className="text-brand-red">{orderId}</span>
          </p>
      ...
      <div className="my-8 w-full max-w-2xl rounded-2xl bg-card shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="p-5">
          ...
          <button
            ...
            className="mt-6 w-full rounded-xl bg-brand-red py-3.5 text-sm font-semibold text-primary-foreground transition-all hover:bg-brand-red/90 disabled:opacity-50"
          >
